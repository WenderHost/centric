...
function centric_home_widgets() {
	...
	genesis_widget_area( 'home-widgets-2', array(
		'before' => '<div id="home-widgets-2" class="home-widgets-2 widget-area">',
		'after'  => '</div>',
	) );

	genesis_widget_area( 'home-widgets-3', array(
		'before' => '<div id="home-widgets-3" class="home-widgets-3 color-section widget-area">',
		'after'  => '</div>',
	) );

	genesis_widget_area( 'home-widgets-4', array(
		'before' => '<div id="home-widgets-4" class="home-widgets-4 dark-section widget-area">',
		'after'  => '</div>',
	) );

	genesis_widget_area( 'home-widgets-5', array(
		'before' => '<div id="home-widgets-5" class="home-widgets-5 widget-area">',
		'after'  => '</div>',
	) );

	genesis_widget_area( 'home-widgets-6', array(
		'before' => '<div id="home-widgets-6" class="home-widgets-6 color-section widget-area">',
		'after'  => '</div>',
	) );
